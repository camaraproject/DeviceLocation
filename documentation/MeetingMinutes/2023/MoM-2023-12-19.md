...
* Review latest comments in ongoing PRs for APIs, and decide if ready to be merged:
  - [location-verification.yaml v0.2 Release Candidate](https://github.com/camaraproject/DeviceLocation/blob/r4.1/code/API_definitions/location-verification.yaml)
       - Already merged
